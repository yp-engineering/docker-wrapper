...
type DockerRunCommandFlags struct {
	...
	LxcConf          []string       `long:"lxc-conf" description:"Add custom lxc options"`
	...
	PublishService   string         `long:"publish-service" description:"Publish this container as a service"`
